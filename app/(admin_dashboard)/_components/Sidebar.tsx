...
import { FaAccusoft, FaHome, FaPaperclip } from 'react-icons/fa';
...
const Sidebar: React.FC<SidebarProps> = ({ children }) => {
    ...
    const sidebarItems = [
        ...
        { icon: <FaAccusoft />, text: "Departments", href: "/admin_dashboard/departments" },
        {
            icon: <FaPaperclip />,
            text: "Applications",
            href: "/admin_dashboard/applications",
        }, { icon: <GiFeather />, text: "Promotional", href: "/admin_dashboard/promotional" },
